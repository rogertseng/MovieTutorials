    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your MovieTutorials Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your MovieTutorials Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "MovieTutorials";
        }
