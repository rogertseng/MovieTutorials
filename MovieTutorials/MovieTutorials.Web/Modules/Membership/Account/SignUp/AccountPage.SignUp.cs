...
using MovieTutorials.Administration;
using MovieTutorials.Administration.Entities;
using MovieTutorials.Administration.Repositories;
using MovieTutorials.Common;
using Serenity;
using Serenity.Data;
...
namespace MovieTutorials.Membership.Pages
{
